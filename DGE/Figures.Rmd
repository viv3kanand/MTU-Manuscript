...
ggpubr::ggmaplot(res$`50_vs_0.1`,fdr = 0.05, fc = 1.1, size = 0.8,
                 ...
                 font.legend = "bold",
                 font.main = "bold",
                 ggtheme = ggplot2::theme(text = element_text(size = 12, family = "Times New Roman"), axis.text.x = element_text(size = 12, family = "Times New Roman"), axis.text.y = element_text(size = 12, family = "Times New Roman"),axis.title = element_text(size = 12, family = "Times New Roman"), legend.position = "right"))
```
...
data_operon <- data_operon[match(operons$Gene, rownames(data_operon)),] %>% na.omit() #Order genes with operon
...
#Gene symbol mapping
data.frame(gendf[gendf$gene_id %in% c("gene-Rv0098", "gene-Rv3019c", "gene-Rv3020c", "gene-Rv3904c", "gene-Rv3905c", "gene-Rv0603", "gene-Rv0828c", "gene-Rv2377c"),]) %>% tibble
```
